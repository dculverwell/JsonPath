 ...
 */
package com.dculverwell.jsonpath;

import com.dculverwell.jsonpath.internal.JsonFormatter;
import com.dculverwell.jsonpath.internal.JsonReader;
import com.dculverwell.jsonpath.internal.PathToken;
import com.dculverwell.jsonpath.internal.Utils;
import com.dculverwell.jsonpath.spi.JsonProvider;
import com.dculverwell.jsonpath.spi.JsonProviderFactory;
import com.dculverwell.jsonpath.spi.MappingProviderFactory;
...
import static com.dculverwell.jsonpath.internal.Utils.*;
...
public class JsonModel {
     ...
     * @see com.dculverwell.jsonpath.JsonPath#isPathDefinite()
     */
     ...
     * be definite ({@link com.dculverwell.jsonpath.JsonPath#isPathDefinite()}).
     * <p/>
    ...
    public interface ObjectMappingModelReader {
        /**
         * Converts this JsonModel to the specified class using the configured {@link com.dculverwell.jsonpath.spi.MappingProvider}
         *
    ...
    public interface ListMappingModelReader {
        /**
         * Converts this JsonModel to the a list of objects with the provided class using the configured {@link com.dculverwell.jsonpath.spi.MappingProvider}
         *
        ...
        /**
         * Converts this JsonModel to the a {@link List} of objects with the provided class using the configured {@link com.dculverwell.jsonpath.spi.MappingProvider}
         *
         * @param targetClass class to convert the {@link JsonModel} array items to
         * @param <T>         template class
         * @return the mapped mode
        ...
        /**
         * Converts this JsonModel to the a {@link Set} of objects with the provided class using the configured {@link com.dculverwell.jsonpath.spi.MappingProvider}
         *
         * @param targetClass class to convert the {@link JsonModel} array items to
         * @param <T>         template class
         * @return the mapped model
